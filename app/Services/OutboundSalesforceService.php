    ...
    private function mapData($module,$data,$function = 'fetch'){
        ...
        if(!empty($map)){
            ...
            foreach($parents as $parent) {
                ...
                foreach ($parentrelations as $name => $relation) {
                    if(isset($data[$name]))$cond[$relation] = $data[$name];
                }
    ...
    private function processObject($objectName,$salesForceObject,$cond = [],$curd = 'fetch') {
        ...
        switch ($curd){
            ...
            case 'upd' :
                ...
                {
                    if(isset($salesForceObject->Id)) unset($salesForceObject->Id);
